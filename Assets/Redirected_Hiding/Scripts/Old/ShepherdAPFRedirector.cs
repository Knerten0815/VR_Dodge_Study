...
namespace RD_Hiding
{
    public class ShepherdAPFRedirector : APF_Redirector
    {
        ...
        public void GetRepulsiveForceAndNegativeGradient(List<List<Vector2>> obstaclePolygons, List<Vector2> trackingSpacePoints, out float rf, out Vector2 ng)
        {
            ...
            else
            {
                ...
                ng = -currPosReal.normalized;
            }
            Debug.Log("CurrRealPos: " + currPosReal);
            Debug.Log("Repulsive Force: " + rf);
            Debug.Log("Negative Gradient: " + ng);
